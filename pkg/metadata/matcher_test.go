...
func TestHeaderStringMatch(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name:   "should-match",
			key:    "th",
			sm:     xstrings.NewExactMatcher(newStringP("tv"), false),
			invert: false,
			md:     Pairs("th", "tv"),
			want:   true,
		},
		{
			name:   "not match",
			key:    "th",
			sm:     xstrings.NewContainsMatcher(newStringP("tv"), false),
			invert: false,
			md:     Pairs("th", "not-match"),
			want:   false,
		},
		{
		...
		},
		{
			...
			sm:     xstrings.NewContainsMatcher(newStringP("tv"), false),
			invert: false,
			md:     Pairs("not-specified-key", "not-match"),
			want:   false,
		},
		{
