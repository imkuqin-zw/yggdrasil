...
import (
	...
	protoenc "github.com/imkuqin-zw/yggdrasil/pkg/remote/protocol/grpc/encoding/proto"
	"github.com/imkuqin-zw/yggdrasil/pkg/remote/protocol/grpc/encoding/proto/codec_perf"
	"github.com/imkuqin-zw/yggdrasil/pkg/remote/protocol/grpc/transport"
	"github.com/imkuqin-zw/yggdrasil/pkg/remote/protocol/grpc/transport/testutils"
...
func TestToRPCErr(t *testing.T) {
	for _, test := range []struct {
		...
		{transport.ErrConnClosing, status.Errorf(code.Code_UNAVAILABLE, transport.ErrConnClosing.Desc)},
		{io.ErrUnexpectedEOF, status.Errorf(code.Code_INTERNAL, io.ErrUnexpectedEOF.Error())},
	} {
